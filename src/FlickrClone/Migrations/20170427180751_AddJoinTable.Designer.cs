...
namespace FlickrClone.Migrations
{
    ...
    [Migration("20170427180751_AddJoinTable")]
    partial class AddJoinTable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FlickrClone.Models.ImageTag", b =>
                {
                    b.Property<int>("ImageId");
            ...
            modelBuilder.Entity("FlickrClone.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlickrClone.Models.ImageTag", b =>
                {
                    b.HasOne("FlickrClone.Models.Image", "Image")
                        .WithMany("ImageTags")
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("FlickrClone.Models.Tag", "Tag")
                        .WithMany("ImageTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
